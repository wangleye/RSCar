...
consts = {
    ...
    'outputdir':'../data/sjtu/oneclass/feature.txt',
        ...
        for date in data[vin].keys():
            ...
            for i in range(0,len(latarr)):
                ...
                if(i>1):
                    ...
                    distance += math.sqrt(latdist*latdist + lngdist*lngdist)
            ...
            try:
                ...
                print c
            writestr = map(lambda x:str(x),[vin,date,distance,cmean,centropy])
